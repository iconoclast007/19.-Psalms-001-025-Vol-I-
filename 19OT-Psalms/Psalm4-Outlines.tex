...
\begin{compactenum}[I.]
    \item \textbf{Consideration for God's Enemies} \index[scripture]{Psalms!Psa 004:01}(Psalm 4:1)
    \item \textbf{Call to the Faithful One} \index[scripture]{Psalms!Psa 004:01}(Psalm 4:1)
    \item \textbf{Confidence in God's Way} \index[scripture]{Psalms!Psa 004:01}(Psalm 4:1)
    \item \textbf{Contentment in Heart} \index[scripture]{Psalms!Psa 004:07}(Psalm 4:7)
    \item \textbf{Countenance Provided} \index[scripture]{Psalms!Psa 004:06}(Psalm 4:6)
    \item \textbf{Confirmation of Presence} \index[scripture]{Psalms!Psa 004:08}(Psalm 4:8)
    \item \textbf{Calmness and Peace} \index[scripture]{Psalms!Psa 004:08}(Psalm 4:8)
\end{compactenum}
...
\index[date]{unknown!Psalm 004 (The Ministry of Lies) (Keith Anthony)}
\begin{compactenum}[I.]
